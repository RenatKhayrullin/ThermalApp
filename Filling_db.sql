...
--Данные о сторонних источниках
insert into ont.thirdparty_resources 
(id, resource_name, url, apikey, accept_data, accept_charset, search_parameter, additional)
values (1, 'ChemSpider', 'http://rdf.chemspider.com//search//{entity}', '', 'text/xml', 'UTF-8', 'formula', '');
insert into ont.thirdparty_resources 
(id, resource_name, url, apikey, accept_data, accept_charset, search_parameter, additional)
values (2, 'Bioontology', 'http://data.bioontology.org/search?apikey={apikey}&q={entity}', '029b37aa-5f26-4304-a139-b14e96b8aae8', 'application/json', 'UTF-8', 'substance', 'collection');

insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (1, 1, 'chemSpiderURL', 'ChemSpider Id. Link to source');
insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (2, 1, 'pictureURL', 'Download ChemSpider Image');
insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (3, 1, 'systematicName', 'ChemSpider Systematic Name');
insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (4, 1, 'formula', 'ChemSpider Formula');
insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (5, 2, 'links.self', 'Bioontology Link');
insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (6, 2, 'definition', 'Bioontology Description');
insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (7, 2, 'prefLabel', 'Bioontology Systematic Name');
insert into ont.resource_columns
(id, resource_number, column_name, column_comment)
values (8, 2, '@type', 'OWL Type');
